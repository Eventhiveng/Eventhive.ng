...
export const blogPageData: BlogPageData[] = [
  ...
  },
  {
    ...
    description: `
        <p>
          Africa’s leading B2B2C event servicing company, Eventhive has announced the return of its annual Lagos Tech Fest in 2024.
        </p>
        <br>
        <p>
          The 2024 edition of the event is set to happen on the 15th of February, 2024 at the Landmark Event Center, Lagos. The annual event now in its 4th edition is a high caliber Nigeria tech-focused conference, exhibitions and networking platform. The event annually provides a veritable platform for discussions and deal-making between leading tech stakeholders. The event addresses key developments in the African tech ecosystem while uncovering the countless opportunities within the Nigerian and African tech markets.
        </p>
        <br>
        <p>
          Lagos Tech Fest will bring together entrepreneurs, disruptors, innovators, investors, venture capitalists, and tech enthusiasts to explore opportunities and navigate challenges within the tech ecosystem focusing on areas such as Fintech, DeFi & Crypto, Forex, Investment, Edtech, Payment & Banking, Insurtech, Healthtech, E-commerce, Funding & Exits, Government Policies, Digital ID & Fraud, and more.
        </p>
        <br>
        ...
        <p>
          Speaking about their participation, <b>Folasade Femi-Lawal, the Country Manager, West Africa at Mastercard,</b> said, "This year, Mastercard proudly takes center stage as the Platinum Sponsor of Lagos Tech Fest, solidifying our commitment to spearheading innovation and digital transformation in Africa's vibrant tech ecosystem. At the event, we aim to foster collaboration, showcase digital payment advancements, and contribute to financial and digital inclusion efforts—empowering one billion people, 50 million small businesses, with a focus on uplifting 25 million women entrepreneurs. Our commitment extends beyond the event, as we contribute to propelling the Nigeria’s tech landscape to new heights.
        </p>
        <br>
        <p>
          Lagos Tech Fest annually hosts tech leaders from the African ecosystem and their international counterparts, all in one place. The event provides an opportunity to network with key industry leaders including tech corporates, startup founders, fintech, investors, regulators, and other stakeholders leading the charge on accelerating investments into the ecosystem.
